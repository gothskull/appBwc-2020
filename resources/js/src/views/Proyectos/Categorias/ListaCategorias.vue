<template>
    <div
        ...
        id="kt_content"
    >
    <TitleSection titleSec="Categorías de Proyectos"/>
                        ...
                        >
                            ...
                            <tbody>
                                <tr v-for="cat of categorias" :key="cat.id">
                                    <td v-text="cat.id"></td>
                                    <td v-text="cat.nameCategoria"></td>
                                    <td v-text="cat.descCategoria"></td>
                                    <td class="text-center">
                                        <span
                                            class="kt-badge  kt-badge--inline kt-badge--pill kt-badge--rounded"
                                            :class="[cat.estado == 1 ? 'kt-badge--success' : 'kt-badge--danger']"
                                        >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input
                                            ...
                                            v-model="categoria.nameCategoria"
                                            :class="{
                                                'is-invalid': errors.nameCategoria
                                            }"
                                        />
                                        <div
                                            v-if="errors.nameCategoria"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <textarea
                                            ...
                                            v-model="categoria.descCategoria"
                                        >
                                        </textarea>
...
export default {
    data() {
        return {
            ...
            hasError: "false",
            nuevaCategoria: "",
            categoria: { id: "", nameCategoria: "", descCategoria: "", estado: "" }
        };
    },
    components : {
        TitleSection
