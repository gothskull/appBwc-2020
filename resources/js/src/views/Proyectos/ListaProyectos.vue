		...
		<div class="kt-subheader   kt-grid__item mt-3" id="kt_subheader">
			<div class="kt-container  kt-container--fluid ">
				...
				<div class="kt-subheader__toolbar">
					...
					<router-link to="/NvoProyecto" class="btn btn-label-brand btn-bold">
						Agregar Proyecto 
					</router-link>
					<div class="kt-subheader__wrapper">
						<div class="dropdown dropdown-inline" data-toggle="kt-tooltip-" title="Quick actions" data-placement="left">
							<router-link to="/NvoProyecto" class="btn btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<div class="kt-widget__head">
									<div class="kt-widget__label">
										<div class="kt-widget__media">
											...
											<span class="kt-userpic kt-userpic--lg kt-userpic--circle kt-hidden">
												<img src="assets/media/users/100_11.jpg" alt="image">
											</span>
										</div>
										<div class="kt-widget__info kt-margin-t-5">
