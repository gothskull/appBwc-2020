				...
				<div class="kt-subheader__main">
					...
					<div class="kt-subheader__group" id="kt_subheader_search">
						<span class="kt-subheader__desc" id="kt_subheader_total">
							Escribe aquí la información del proyecto</span>
					</div>
				</div>
				<div class="kt-subheader__toolbar">
					<router-link to="/ListaProyectos" class="btn btn-default btn-bold">
						Regresar 
					</router-link>
					<div class="btn-group">
						...
						<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
							...
							<form class="kt-form" id="kt_projects_add_form">
								...
								<div class="kt-wizard-v1__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
									<div class="kt-heading kt-heading--md">Detalles del Proyecto</div>
												...
												<div class="col-xl-12">
													<div class="kt-section__body">
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Nombre del proyecto</label>
															<div class="col-lg-9 col-xl-9">
																<input class="form-control" type="text" value="">
															</div>
														</div>
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Descripción del proyecto</label>
															<div class="col-lg-9 col-xl-9">
																<textarea class="form-control" id="" cols="30" rows="3"></textarea>
															</div>
														</div>
														<div class="form-group row">
															<label class="col-form-label col-lg-3 col-sm-12">	Reresentante
															</label>
															<div class=" col-lg-9 col-md-9 col-sm-12">
																<v-select 
																	class="" 
																	id="" 
																	placeholder="Escribe aquí el nombre del representante que buscas"
																	:options="options">
																</v-select>
															</div>
														</div>
														<div class="form-group row">
															<label class="col-form-label col-lg-3 col-sm-12">	Input Group Setup
															</label>
														...
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Costo </label>
															<div class="col-lg-9 col-xl-9">
																<div class="input-group">
														...
														<div class="form-group form-group-last row">
															<label class="col-xl-3 col-lg-3 col-form-label">URL del sitio</label>
															<div class="col-lg-9 col-xl-9">
																<div class="input-group">
